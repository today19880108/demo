...
<script type="text/javascript" src="${path}/web/base/department/js/departPage.js"></script>
<link rel="stylesheet" type="text/css" href="${path}/web/base/department/css/departPage.css" />
