...
<script type="text/javascript" src="${path}/web/base/projecttype/js/projecttypePage.js"></script>
<link rel="stylesheet" type="text/css" href="${path}/web/base/projecttype/css/projecttypePage.css" />
